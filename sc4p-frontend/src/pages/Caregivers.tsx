  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <p className="font-semibold"> First and Last Name
          <Input
            variant="bordered"
            radius="lg"
            color="secondary"
      ...
      <div className="space-y-4">
        <p className="font-semibold"> Care-giving Length <br/>
        <Dropdown>
        <DropdownTrigger>
      ...
      <div className="space-y-4">
        <p className="font-semibold"> Cell Phone
          <Input
            variant="bordered"
            radius="lg"
            color="secondary"
      ...
      <div className="space-y-4">
        <p className="font-semibold"> City
          <Input
            variant="bordered"
            radius="lg"
            color="secondary"
      ...
      <div className="space-y-4">
        <p className="font-semibold"> State
          <Input
            variant="bordered"
            radius="lg"
            color="secondary"
      ...
      <h2 className="text-xl font-semibold">Pet Sitters and Boarding Facilities</h2>
      <p className="text-sm mb-4">
        Should your designated caregiver go on vacation or be temporarily unavailable to care for your pets, who should take care of them?
      </p>
      <br />
      ...
      <div className="space-y-4">
        <p className="font-semibold"> Average Daily Charge
          <Input
            variant="bordered"
            radius="lg"
            color="secondary"
